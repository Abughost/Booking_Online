...
# from root.settings import NGROK_URL, BOT_TOKEN
#
# WEBHOOK_URL = f'https://{NGROK_URL}/webhook/bot'
#
# dp = Dispatcher()
#
# # async def main() -> None:
...
#         print(f"Webhook ornatishda xato: {e}")
#     finally:
#         await bot.session.close()
#
#
# class BotConfig(AppsConfig):
...
#     logging.basicConfig(level=logging.INFO, stream=sys
#                         .stdout)
...
from root.settings import BOT_TOKEN, WEBHOOK_SECRET
